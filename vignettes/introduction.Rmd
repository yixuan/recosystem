...
in a single machine. `LIBMF` itself is a parallelized library, meaning that
...
written into a file rather than kept in memory.
...
(extracting $P$ and $Q$ matrices) and prediction.
