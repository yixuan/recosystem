...
#pragma omp parallel for num_threads(util.get_thread_number()) schedule(static)
        ...
        Rcout << outer;
        Rcout.width(13);
        Rcout << fixed << setprecision(4) << positive_loss + negative_loss;
        Rcout.width(15);
        Rcout << fixed << setprecision(4) << positive_loss;
        Rcout.width(15);
        Rcout << fixed << setprecision(4) << negative_loss;
...
#pragma omp parallel for num_threads(util.get_thread_number()) schedule(static)
            ...
            Rcout.width(13);
            Rcout << fixed << setprecision(4) << va_positive_loss + va_negative_loss;
            Rcout.width(15);
            Rcout << fixed << setprecision(4) << va_positive_loss;
            Rcout.width(15);
            Rcout << fixed << setprecision(4) << va_negative_loss;
        }

        Rcout.width(13);
        Rcout << fixed << setprecision(4) << scientific << obj;
        Rcout << "\n" << flush;
    }
...
bool check_parameter(mf_parameter param)
{
    ...
    if(param.alpha < 0)
    {
        ...
        Rcpp::stop("alpha must be a non-negative number");
    }
